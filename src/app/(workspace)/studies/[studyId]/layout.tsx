...
export default async function StudyLayout({ children, params }: { children: React.ReactNode; params: Promise<{ studyId: string }> }) {
  ...
  return (
    <div className="mx-auto max-w-4xl py-6 sm:py-10">
      <p className="text-xs font-bold uppercase tracking-[0.16em] text-primary">Study route preview</p>
      <h1 className="mt-2 text-3xl font-bold tracking-tight">Study workspace</h1>
      <p className="mt-3 text-sm leading-6 text-muted-foreground">No study is loaded. Study records and access checks arrive in later phases.</p>
